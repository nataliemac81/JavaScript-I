...
const result = inventory.find(car => car.id === 33);

const carMake = result.car_make;
const carYear = result.car_year;
const carModel = result.car_model;
const message = "Car 33 is a " + carYear + " " + carMake + " " + carModel;
...
// ==== Challenge 4 ====
// The accounting team needs all the years from every crar on the lot. Create a new array from the dealer data containing only the car years and log the result in the console.
let carYears = [];
